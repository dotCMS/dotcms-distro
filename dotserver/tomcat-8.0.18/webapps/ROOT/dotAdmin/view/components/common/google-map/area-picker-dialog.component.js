System.register(['@angular/core', '../modal-dialog/dialog-component', '../../../../api/maps/GoogleMapService', '../../../../api/services/logger.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, dialog_component_1, GoogleMapService_1, logger_service_1;
    ...
    return {
        ...
        execute: function() {
            ...
            AreaPickerDialogComponent = (function () {
                function AreaPickerDialogComponent(mapsService, loggerService) {
                ...
                AreaPickerDialogComponent.prototype.ngOnChanges = function (change) {
                    ...
                    if (change.hidden && this.hidden && this.map) {
                        this.loggerService.debug("AreaPickerDialogComponent", "ngOnChanges", 'hiding map: ', this.map.getDiv().getAttribute('id'), this.map.getDiv()['style']['height']);
                        /**
                         *
                ...
                AreaPickerDialogComponent.prototype.readyMap = function () {
                    ...
                    if (!el) {
                        ...
                        google.maps.event.addListener(circle, 'radius_changed', function () {
                            _this.loggerService.debug('radius changed', circle.getRadius(), _this.circle.radius);
                            var ll = circle.getCenter();
                            var center = { lat: ll.lat(), lng: ll.lng() };
                            _this.circle = { center: center, radius: circle.getRadius() };
                            _this.loggerService.debug('radius changed to', circle.getRadius(), _this.circle.radius);
                        });
                    }
                };
                ...
                ], AreaPickerDialogComponent.prototype, "apiKey", void 0);
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', String)
                ...
                AreaPickerDialogComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [dialog_component_1.ModalDialogComponent],
                    ...
                    __metadata('design:paramtypes', [GoogleMapService_1.GoogleMapService, logger_service_1.LoggerService])
