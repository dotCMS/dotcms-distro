System.register(['@angular/core', '@angular/forms', "../../../api/rule-engine/Rule", "../../../api/system/locale/I18n", "../../../api/auth/UserModel", "../../../api/persistence/ApiRoot"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, forms_1, Rule_1, I18n_1, UserModel_1, ApiRoot_1;
        ...
        execute: function() {
            ...
            RuleComponent = (function () {
                ...
                RuleComponent.prototype.initFormModel = function (fb) {
                    var vFns = [];
                    vFns.push(forms_1.Validators.required);
                    vFns.push(forms_1.Validators.minLength(3));
                    this.formModel = fb.group({
                        name: new forms_1.FormControl(this.rule ? this.rule.name : '', forms_1.Validators.compose(vFns))
                    });
                };
                ...
                RuleComponent.prototype.ngOnChanges = function (change) {
                    ...
                    if (change.rule) {
                        ...
                        ctrl_1.patchValue(this.rule.name, {});
                ...
                RuleComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [UserModel_1.UserModel, core_1.ElementRef, I18n_1.I18nService, Rule_1.RuleService, ApiRoot_1.ApiRoot, forms_1.FormBuilder])
                ], RuleComponent);
