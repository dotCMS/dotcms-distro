System.register(['@angular/core', "../../../api/rule-engine/Rule", "../../../api/rule-engine/ServerSideFieldModel", "../../../api/rule-engine/Condition", "../../../api/rule-engine/Action", "../../../api/rule-engine/ConditionGroup", "../../../api/system/locale/I18n", "rxjs/Observable", "../../../api/services/bundle-service", '@angular/router'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, Rule_1, ServerSideFieldModel_1, Condition_1, Action_1, ConditionGroup_1, I18n_1, Observable_1, bundle_service_1, router_1;
    ...
    return {
        ...
        execute: function() {
            ...
            RuleEngineContainer = (function () {
                function RuleEngineContainer(_ruleService, _ruleActionService, _conditionGroupService, _conditionService, _resources, bundleService, route) {
                    var _this = this;
                ...
                RuleEngineContainer.prototype.initRules = function () {
                    ...
                    this._ruleService.requestRules(siteId).subscribe(function (rules) {
                        console.log('requestRules success', rules);
                        _this.loadRules(rules);
                        _this._ruleService.loadRules().subscribe(function (rules) {
                            _this.loadRules(rules);
                        });
                    });
                };
                RuleEngineContainer.prototype.loadRules = function (rules) {
                ...
                RuleEngineContainer = __decorate([
                    ...
                    __metadata('design:paramtypes', [Rule_1.RuleService, Action_1.ActionService, ConditionGroup_1.ConditionGroupService, Condition_1.ConditionService, I18n_1.I18nService, bundle_service_1.BundleService, router_1.ActivatedRoute])
                ], RuleEngineContainer);
