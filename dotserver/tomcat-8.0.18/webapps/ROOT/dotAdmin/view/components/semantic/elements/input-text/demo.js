System.register(['@angular/core', '@angular/forms', "./input-text"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, forms_1, input_text_1;
        ...
        execute: function() {
            ...
            HeroFormComponent = (function () {
                function HeroFormComponent(fb) {
                    ...
                    this.model = fb.group({
                        name: new forms_1.FormControl(this.hero.name, forms_1.Validators.minLength(5)),
                        alterEgo: new forms_1.FormControl(this.hero.alterEgo, forms_1.Validators.required),
                        power: new forms_1.FormControl(this.hero.power)
                    });
                }
                ...
                HeroFormComponent = __decorate([
                    core_1.Component({
                        selector: 'hero-form',
                        directives: [input_text_1.InputText, forms_1.FormGroup],
            ...
            App = (function () {
                function App(fb) {
                    this.model = fb.group({
                        demoOneCtrl: new forms_1.FormControl('test', forms_1.Validators.minLength(5)),
                        someDate: new forms_1.FormControl(new Date().toISOString().split('T')[0], function (c) {
                            var v;
                            try {
                ...
                App = __decorate([
                    core_1.Component({
                        selector: 'demo',
                        directives: [input_text_1.InputText, forms_1.FormGroup, HeroFormComponent],
