System.register(['@angular/core', '@angular/forms', 'lodash'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            ...
            InputDate = (function () {
                ...
                InputDate.prototype.writeValue = function (value) {
                    this._modelValue = lodash_1.default.isEmpty(value) ? InputDate.DEFAULT_VALUE : value;
