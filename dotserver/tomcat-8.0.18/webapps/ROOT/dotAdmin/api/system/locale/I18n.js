System.register(['@angular/core', '@angular/http', 'rxjs/Rx', '../../persistence/ApiRoot', '../../validation/Verify', '../../services/logger.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, Rx_1, ApiRoot_1, Verify_1, logger_service_1;
    ...
    return {
        ...
        execute: function() {
            ...
            I18nService = (function () {
                function I18nService(apiRoot, http, loggerService) {
                        ...
                        var promise = new Promise(function (resolve, reject) {
                            _this.makeRequest(path.join('/')).catch(function (err, source) {
                                if (err && err.status === 404) {
                                    _this.loggerService.debug("Missing Resource: '", msgKey, "'");
                                }
                                else {
                                    _this.loggerService.debug("I18n", "Failed:: ", msgKey, "=", cNode, 'error:', err);
                                }
                    ...
                    return Rx_1.Observable.defer(function () {
                        return Rx_1.Observable.create(function (obs) {
                            if (cNode._loading == null) {
                                _this.loggerService.debug("I18n", "Failed: ", msgKey, "=", cNode);
