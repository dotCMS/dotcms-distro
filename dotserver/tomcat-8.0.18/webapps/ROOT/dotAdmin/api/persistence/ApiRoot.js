System.register(['@angular/core', '@angular/http', '../auth/UserModel', '../services/logger.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, UserModel_1, logger_service_1;
    var ApiRoot;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            ApiRoot = (function () {
                function ApiRoot(authUser, loggerService) {
                ...
                ApiRoot = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [UserModel_1.UserModel, logger_service_1.LoggerService])
                ], ApiRoot);
                return ApiRoot;
            }());
