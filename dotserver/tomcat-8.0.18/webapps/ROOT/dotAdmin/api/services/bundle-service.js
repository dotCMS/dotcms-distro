System.register(['@angular/core', '@angular/http', 'rxjs/Rx', "../persistence/ApiRoot", "../services/core-web-service"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, Rx_1, ApiRoot_1, core_web_service_1;
    var BundleService;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            BundleService = (function () {
                function BundleService(_apiRoot, coreWebService) {
                ...
                BundleService.prototype._doLoadBundleStores = function () {
                    ...
                    return this.getLoggedUser().flatMap(function (user) {
                        return _this.coreWebService.request({
                            method: http_1.RequestMethod.Get,
                ...
                BundleService = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [ApiRoot_1.ApiRoot, core_web_service_1.CoreWebService])
                ], BundleService);
