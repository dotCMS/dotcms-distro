System.register(['./core-web-service', '@angular/http', '@angular/core'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_web_service_1, http_1, core_1;
    var AccountService;
    return {
        setters:[
        ...
        execute: function() {
            AccountService = (function () {
                function AccountService(coreWebService) {
