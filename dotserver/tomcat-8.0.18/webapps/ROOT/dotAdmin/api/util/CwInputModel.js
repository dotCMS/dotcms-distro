System.register(["@angular/forms", "../validation/CustomValidators"], function(exports_1, context_1) {
    "use strict";
    ...
    var forms_1, CustomValidators_1;
        ...
        execute: function() {
            ...
            DataTypeModel = (function () {
                ...
                DataTypeModel.prototype.validator = function () {
                    return forms_1.Validators.compose(this.validators());
                };
                ...
                CwInputDefinition.prototype.validator = function () {
                    if (this._validator == null) {
                        ...
                        if (this._vFns && this._vFns.length) {
                            this._validator = forms_1.Validators.compose(this._vFns);
                        }
                        else {
