System.register(['@angular/core', '@angular/http', 'rxjs/Rx', "../persistence/ApiRoot", "./ServerSideFieldModel", "../system/locale/I18n", "../services/core-web-service", "../services/site-service", 'rxjs/Subject'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, Rx_1, ApiRoot_1, ServerSideFieldModel_1, I18n_1, core_web_service_1, site_service_1, Subject_1;
    ...
    return {
        ...
        execute: function() {
            ...
            RuleService = (function () {
                function RuleService(_apiRoot, _resources, siteService, coreWebService) {
                    var _this = this;
                    this._apiRoot = _apiRoot;
                    this._resources = _resources;
                    this.siteService = siteService;
                    this.coreWebService = coreWebService;
                    this._rules$ = new Subject_1.Subject();
                ...
                Object.defineProperty(RuleService.prototype, "rules", {
                    get: function () {
                        return this._rules;
                    },
                    enumerable: true,
                ...
                RuleService.prototype.requestRules = function (siteId) {
                    if (siteId) {
                ...
                RuleService.prototype.sendLoadRulesRequest = function (siteId) {
                    var _this = this;
                    return this.coreWebService.request({
                        method: http_1.RequestMethod.Get,
                        url: this._apiRoot.baseUrl + "api/v1/sites/" + siteId + "/ruleengine/rules"
                    }).map(function (ruleMap) {
                        _this._rules = RuleService.fromServerRulesTransformFn(ruleMap);
                        _this._rules$.next(_this.rules);
                        _this.siteService.switchSite$.subscribe(function (site) {
                            _this.sendLoadRulesRequest(site.identifier);
                        });
                ...
                RuleService = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [ApiRoot_1.ApiRoot, I18n_1.I18nService, site_service_1.SiteService, core_web_service_1.CoreWebService])
                ], RuleService);
                return RuleService;
            }());
