System.register(["../util/CwModel", "../util/CwInputModel", "@angular/forms", "../validation/CustomValidators"], function(exports_1, context_1) {
    "use strict";
    ...
    var CwModel_1, CwInputModel_1, forms_1, CustomValidators_1;
        ...
        execute: function() {
            ServerSideFieldModel = (function (_super) {
                ...
                ServerSideFieldModel.createNgControl = function (model, paramName) {
                    ...
                    var control = new forms_1.FormControl(model.getParameterValue(param.key), forms_1.Validators.compose(vFn));
                    return control;
                };
